...
def drawClock(mc, clockCentre, radius, time):
    ...
    #draw hour hand
    drawHourHand(mc, clockCentre, time.hour, time.minute, block.GOLD_BLOCK)
    
    #draw minute hand
    drawMinuteHand(mc, clockCentre, time.minute, block.OBSIDIAN)

    #draw second hand
    drawSecondHand(mc, clockCentre, time.second, block.IRON_BLOCK)
...
if __name__ == "__main__":
    ...
    mc.postToChat("Hi, Minecraft Analogue Clock, www.stuffaboutcode.com")
     mc.postToChat("and is modfied by lukkan99")
